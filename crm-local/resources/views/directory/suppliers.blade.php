<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Справочник. Поставщики</h2>
    </x-slot>
    ...
    <main class="w-full px-2 sm:px-4 py-6">
        ...
        <!-- Заголовок -->
        <h3 class="text-lg font-semibold mb-2">Поставщики. Справочник</h3>

        <!-- Кнопка добавления -->
        <button onclick="document.getElementById('create-supplier-modal').classList.remove('hidden')"
            ...
            <table class="w-full text-sm border-collapse">
                <thead class="bg-blue-50 text-xs uppercase">
                    <tr>
                        ...
                        <th class="p-2 border">Кто создал</th>
                        <th class="p-2 border"></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="p-2 border">5010058866</td>
                        <td class="p-2 border">ООО "ЗАВОД СТРОИТЕЛЬНЫХ ЭЛЕМЕНТОВ"</td>
                        <td class="p-2 border">г. Москва, ул. Строителей, д.7</td>
                        <td class="p-2 border">+7 (495) 123-45-67</td>
                        <td class="p-2 border">Важно!</td>
                        <td class="p-2 border text-center">
                            <img src="https://randomuser.me/api/portraits/men/32.jpg" alt="User" class="w-8 h-8 rounded-full border inline-block">
                        </td>
                        <td class="p-2 border text-center">
                    ...
                    <tr>
                        <td class="p-2 border">7701234567</td>
                        <td class="p-2 border">Газпром</td>
                        <td class="p-2 border"></td>
                        <td class="p-2 border"></td>
                        <td class="p-2 border"></td>
                        <td class="p-2 border text-center">
                            <img src="https://randomuser.me/api/portraits/women/44.jpg" alt="User" class="w-8 h-8 rounded-full border inline-block">
                        </td>
                        <td class="p-2 border text-center">
                            <i class="bi bi-pencil cursor-pointer text-blue-600"></i>
                        </td>
    ...
    <!-- Модалка создания -->
    <div id="create-supplier-modal" class="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center hidden z-50">
        <div class="bg-white rounded-xl shadow-xl border border-gray-300 relative" style="width: 600px; max-width: 100%;">
            <div class="bg-[#337AB7] text-white text-sm font-semibold px-4 py-2 rounded-t-xl flex items-center justify-between mb-4">
                <span>Создание карточки поставщика</span>
                <button type="button"
                    onclick="document.getElementById('create-supplier-modal').classList.add('hidden')"
                    class="text-white text-xl font-bold leading-none hover:text-gray-300 transition">&times;
                </button>
            </div>
            <form class="p-4">
                <div class="flex items-center gap-3 mb-3">
                    <label class="block text-sm w-[120px]">ИНН:</label>
                    <input type="text" placeholder="ИНН" class="border rounded flex-1 px-2 py-1 text-sm" />
                </div>
                <div class="flex items-center gap-3 mb-3">
                    <label class="block text-sm w-[120px]">Наименование:</label>
                    <input type="text" placeholder="ООО Наименование предприятия" class="border rounded flex-1 px-2 py-1 text-sm" />
                </div>
                <div class="flex items-center gap-3 mb-3">
                ...
                <div class="flex justify-end gap-2 pt-3">
                    ...
                    <button type="button" onclick="document.getElementById('create-supplier-modal').classList.add('hidden')" class="bg-red-500 text-white px-4 py-2 rounded text-sm font-semibold">ОТМЕНА</button>
                </div>
            </form>
        </div>
    </div>
