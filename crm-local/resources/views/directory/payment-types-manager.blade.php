<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Справочник. Типы платежей</h2>
    </x-slot>
    ...
    <main class="w-full px-2 sm:px-4 py-6">
        ...
        <!-- Заголовок -->
        <h3 class="text-lg font-semibold mb-2">Справочник. Типы платежей</h3>

        <!-- Кнопка добавления -->
        <button onclick="document.getElementById('create-payment-modal').classList.remove('hidden')"
            class="bg-[#337AB7] hover:bg-blue-700 text-white font-semibold px-4 py-2 rounded text-sm mb-4">
            + Новый тип платежа
        </button>
    ...
    <!-- Модалка создания -->
    <div id="create-payment-modal" class="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center hidden z-50">
        <div class="bg-white rounded-xl shadow-xl border border-gray-300 relative" style="width: 860px; max-width: 100%;">
            <div class="bg-[#337AB7] text-white text-sm font-semibold px-4 py-2 rounded-t-xl flex items-center justify-between mb-4">
                <span>Создание типа платежа</span>
                <button type="button"
                    onclick="document.getElementById('create-payment-modal').classList.add('hidden')"
                    class="text-white text-xl font-bold leading-none hover:text-gray-300 transition">&times;
                </button>
            </div>
            <form class="p-4">
                <div class="flex items-center gap-3 mb-3">
                    <label class="block text-sm w-[140px]">Наименование:</label>
                    <input type="text" placeholder="Наименование" class="border rounded flex-1 px-2 py-1 text-sm" />
                </div>
                <div class="flex items-center gap-3 mb-3">
                    <label class="block text-sm w-[140px]">Краткое название:</label>
                    <input type="text" placeholder="Краткое название" class="border rounded flex-1 px-2 py-1 text-sm" />
                </div>
                <div class="flex items-center gap-3 mb-3">
                    <label class="block text-sm w-[140px]">Цвет ярлыка:</label>
                    <input type="text" placeholder="Цвет ярлыка" class="border rounded flex-1 px-2 py-1 text-sm" />
                </div>
                <div class="flex items-center gap-3 mb-3">
                    <label class="block text-sm w-[140px]">Комментарий:</label>
                    <input type="text" placeholder="Комментарий" class="border rounded flex-1 px-2 py-1 text-sm" />
                </div>
                <div class="flex items-center gap-3 mb-3">
                ...
                <div class="flex justify-end gap-2 pt-3">
                    ...
                    <button type="button" onclick="document.getElementById('create-payment-modal').classList.add('hidden')" class="bg-red-500 text-white px-4 py-2 rounded text-sm font-semibold">ОТМЕНА</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div id="edit-payment-modal" class="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center hidden z-50">
        <div class="bg-white rounded-xl shadow-xl border border-gray-300 relative" style="width: 860px; max-width: 100%;">
            <div class="bg-[#337AB7] text-white text-sm font-semibold px-4 py-2 rounded-t-xl flex items-center justify-between mb-4">
                <span>Редактирование типа платежа</span>
                <button type="button"
                    onclick="document.getElementById('edit-payment-modal').classList.add('hidden')"
                    class="text-white text-xl font-bold leading-none hover:text-gray-300 transition">&times;
                </button>
            </div>
            <form class="p-4">
                <div class="flex items-center gap-3 mb-3">
                    <label class="block text-sm w-[140px]">Наименование:</label>
                    <input type="text" value="Наличные" placeholder="Наименование" class="border rounded flex-1 px-2 py-1 text-sm" />
                </div>
                <div class="flex items-center gap-3 mb-3">
                    <label class="block text-sm w-[140px]">Краткое название:</label>
                    <input type="text" value="нал" placeholder="Краткое название" class="border rounded flex-1 px-2 py-1 text-sm" />
                </div>
                <div class="flex items-center gap-3 mb-3">
                    <label class="block text-sm w-[140px]">Цвет ярлыка:</label>
                    <input type="text" value="#2e8b57" placeholder="Цвет ярлыка" class="border rounded flex-1 px-2 py-1 text-sm" />
                </div>
                <div class="flex items-center gap-3 mb-3">
                    <label class="block text-sm w-[140px]">Комментарий:</label>
                ...
                <div class="flex justify-end gap-2 pt-3">
                    <button type="submit" class="bg-[#337AB7] text-white px-4 py-2 rounded text-sm font-semibold"><i class="bi bi-save"></i> СОХРАНИТЬ ИЗМЕНЕНИЯ</button>
                    <button type="button" onclick="document.getElementById('edit-payment-modal').classList.add('hidden')" class="bg-red-500 text-white px-4 py-2 rounded text-sm font-semibold">ОТМЕНА</button>
                </div>
            </form>
        </div>
    </div>
