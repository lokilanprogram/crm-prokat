<!-- resources/views/directory/persons.blade.php -->
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Физические лица</h2>
    </x-slot>
    ...
    <main class="w-full px-2 sm:px-4 py-6">
        ...
        <div class="flex gap-2 mb-4">
            <label class="block text-sm">Клиент
                <input type="text" value="Иванов" class="border rounded px-2 py-1 text-sm ml-1" />
            </label>
            <label class="block text-sm">Телефон
                <input type="text" class="border rounded px-2 py-1 text-sm ml-1" />
            </label>
            <label class="block text-sm">Паспорт, серия
                <input type="text" class="border rounded px-2 py-1 text-sm ml-1" />
            </label>
            <label class="block text-sm">номер
                <input type="text" class="border rounded px-2 py-1 text-sm ml-1" />
            </label>
            <button class="bg-[#337AB7] text-white px-3 py-1 rounded text-sm ml-2">ФИЛЬТР</button>
            <button class="bg-red-500 text-white px-3 py-1 rounded text-sm ml-2">СБРОСИТЬ</button>
        </div>
            ...
            <table class="w-full text-sm border-collapse">
                <thead class="bg-blue-50 text-xs uppercase">
                    <tr>
                        ...
                        <th class="p-2 border">Паспорт</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="p-2 border">
                            <span class="text-blue-700 underline cursor-pointer">Иванов Александр Сергеевич</span>
                        </td>
                        <td class="p-2 border text-xs">2808 917784, ОТДЕЛЕНИЕМ УФМС РОССИИ ПО ТВЕРСКОЙ ОБЛАСТИ В ЛИХОСЛАВЛЬСКОМ РАЙОНЕ</td>
                        <td class="p-2 border"></td>
                        <td class="p-2 border"></td>
                        <td class="p-2 border text-xs leading-tight text-center">
                            Хохлов Дмитрий<br>
                            <span class="text-gray-500">27.06.2025<br>09:57</span>
                        </td>
                        <td class="p-2 border text-center">
                            <button onclick="document.getElementById('upload-file-modal').classList.remove('hidden')" class="bg-[#337AB7] text-white px-3 py-1 rounded text-xs">ЗАГРУЗКА ФАЙЛА</button>
                        </td>
                    </tr>
                    <tr>
                        <td class="p-2 border text-center">2</td>
                        <td class="p-2 border">
                            <span class="text-blue-700 underline cursor-pointer">Иванов Павел Сергеевич</span>
                        </td>
                        <td class="p-2 border text-xs">2804 581280, ВСЕГИНСКИМ ОТДЕЛОМ ВНУТРЕННИХ ДЕЛ ТВЕРСКОЙ ОБЛАСТИ</td>
                        <td class="p-2 border"></td>
                        <td class="p-2 border"></td>
                        <td class="p-2 border text-xs leading-tight text-center">
                            Хохлов Дмитрий<br>
                            <span class="text-gray-500">25.06.2025<br>09:25</span>
                        </td>
                        <td class="p-2 border text-center">
                            <button onclick="document.getElementById('upload-file-modal').classList.remove('hidden')" class="bg-[#337AB7] text-white px-3 py-1 rounded text-xs">ЗАГРУЗКА ФАЙЛА</button>
                        </td>
                    </tr>
                    <!-- Добавь еще строки по скрину, если надо -->
                </tbody>
            </table>
        </div>
        ...
        <div class="flex justify-center mt-4">
            <button class="bg-[#337AB7] text-white px-6 py-2 rounded">ПОКАЗАТЬ ЕЩЁ</button>
        </div>
        <div class="flex justify-center mt-2 space-x-1">
            <button class="bg-green-500 text-white px-3 py-1 rounded">1</button>
            <button class="bg-white text-blue-600 border px-3 py-1 rounded">2</button>
            <button class="bg-white text-blue-600 border px-3 py-1 rounded">3</button>
            <button class="bg-white text-blue-600 border px-3 py-1 rounded">4</button>
            <button class="bg-white text-blue-600 border px-3 py-1 rounded">5</button>
        </div>
        @section('modals')
