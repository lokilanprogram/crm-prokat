<!-- resources/views/directory/positions.blade.php -->

<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Справочник. Должности</h2>
    </x-slot>
    ...
    <main class="w-full px-2 sm:px-4 py-6">
        ...
        <!-- Заголовок -->
        <h3 class="text-lg font-semibold mb-2">Должности. Справочник</h3>

        <!-- Кнопка добавления -->
        <button onclick="document.getElementById('create-position-modal').classList.remove('hidden')"
            ...
            <table class="w-full text-sm border-collapse">
                <thead class="bg-blue-50 text-xs uppercase">
                    <tr>
                        ...
                        <th class="p-2 border">Название должности</th>
                        <th class="p-2 border text-center"><i class="bi bi-eye"></i></th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="p-2 border">Директор</td>
                        <td class="p-2 border text-center">
                            <input type="checkbox" checked class="h-4 w-4 border-gray-400 rounded" disabled>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="p-2 border">Водитель-экспедитор</td>
                        <td class="p-2 border text-center">
                            <input type="checkbox" checked class="h-4 w-4 border-gray-400 rounded" disabled>
                        </td>
                        <td class="p-2 border"></td>
                    ...
                    <!-- Можешь копировать строки для других должностей -->
                </tbody>
    ...
    <!-- Модалка создания -->
    <div id="create-position-modal" class="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center hidden z-50">
        <div class="bg-white rounded-xl shadow-xl border border-gray-300 relative" style="width: 600px; max-width: 100%;">
            <div class="bg-[#337AB7] text-white text-sm font-semibold px-4 py-2 rounded-t-xl flex items-center justify-between mb-4">
                ...
                <button type="button"
                    onclick="document.getElementById('create-position-modal').classList.add('hidden')"
                    class="text-white text-xl font-bold leading-none hover:text-gray-300 transition">&times;
                </button>
            </div>
            <form class="p-4">
                <div class="flex items-center gap-3 mb-3">
                    <label class="block text-sm w-[120px]">Должность</label>
                ...
                <div class="flex items-center gap-3 mb-3">
                    <label class="block text-sm w-[120px]">Активность</label>
                ...
                <div class="flex justify-end gap-2 pt-3">
                    ...
                    <button type="button" onclick="document.getElementById('create-position-modal').classList.add('hidden')" class="bg-red-500 text-white px-4 py-2 rounded text-sm font-semibold">ОТМЕНА</button>
                </div>
            </form>
        </div>
    </div>
