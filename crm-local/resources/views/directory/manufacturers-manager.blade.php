<!-- resources/views/directory/manufacturers.blade.php -->
<x-app-layout>
    <x-slot name="header">
    ...
    <main class="w-full px-2 sm:px-4 py-6">
        ...
        <h3 class="text-lg font-semibold mb-2">Производители. Справочник</h3>

        <button onclick="document.getElementById('create-manufacturer-modal').classList.remove('hidden')"
            ...
            <table class="w-full text-sm border-collapse">
                <thead class="bg-blue-50 text-xs uppercase">
                    <tr>
                        ...
                        <th class="p-2 border text-center">Фильтр</th>
                        <th class="p-2 border text-center">Логотип</th>
                        <th class="p-2 border">Наименование</th>
                        <th class="p-2 border">Адрес</th>
                        <th class="p-2 border">Контакты</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="p-2 border text-center">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/9/99/ALUMET_logo.png" alt="ALUMET" class="w-16 h-8 object-contain inline-block">
                        </td>
                        <td class="p-2 border font-semibold text-yellow-800">ALUMET</td>
                        <td class="p-2 border"></td>
                        <td class="p-2 border"></td>
                        <td class="p-2 border"></td>
                        <td class="p-2 border text-center">
                            <i class="bi bi-pencil cursor-pointer text-blue-600"></i>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="p-2 border text-center">
                            <img src="https://seeklogo.com/images/B/blacksmith-logo-594DFB3D30-seeklogo.com.png" alt="BLACKSMITH" class="w-16 h-8 object-contain inline-block">
                        </td>
                        <td class="p-2 border font-semibold text-gray-800">BLACKSMITH</td>
                        <td class="p-2 border"></td>
                        <td class="p-2 border"></td>
                        <td class="p-2 border"></td>
                        <td class="p-2 border text-center">
                    ...
                    <tr>
                        ...
                        <td class="p-2 border text-center">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/9/9e/Ryobi_logo.svg" alt="Ryobi" class="w-16 h-8 object-contain inline-block">
                        </td>
                        <td class="p-2 border font-semibold text-gray-800">Ryobi</td>
                        <td class="p-2 border"></td>
                        <td class="p-2 border"></td>
                        <td class="p-2 border"></td>
                        <td class="p-2 border text-center">
                    ...
                    <tr>
                        ...
                        <td class="p-2 border text-center">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/c/cf/AEG_logo.svg" alt="AEG" class="w-16 h-8 object-contain inline-block">
                        </td>
                        <td class="p-2 border font-semibold text-gray-800">AEG</td>
                        <td class="p-2 border"></td>
                        <td class="p-2 border"></td>
                        <td class="p-2 border"></td>
                        <td class="p-2 border text-center">
                    ...
                    <tr>
                        ...
                        <td class="p-2 border text-center">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/c/cf/AEG_logo.svg" alt="ABSOLUT" class="w-8 h-8 inline-block">
                        </td>
                        <td class="p-2 border font-semibold text-gray-800">ABSOLUT</td>
                        <td class="p-2 border"></td>
                        <td class="p-2 border"></td>
                        <td class="p-2 border"></td>
                        <td class="p-2 border text-center">
    ...
    <div id="create-manufacturer-modal" class="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center hidden z-50">
        <div class="bg-white rounded-xl shadow-xl border border-gray-300 relative" style="width: 600px; max-width: 100%;">
            <div class="bg-[#337AB7] text-white text-sm font-semibold px-4 py-2 rounded-t-xl flex items-center justify-between mb-4">
                <span>Создание карточки производителя</span>
                <button type="button"
                    onclick="document.getElementById('create-manufacturer-modal').classList.add('hidden')"
                    class="text-white text-xl font-bold leading-none hover:text-gray-300 transition">&times;
                </button>
            </div>
            <form class="p-4">
                <div class="flex items-center gap-3 mb-3">
                    <label class="block text-sm w-[120px]">Наименование</label>
                    <input type="text" placeholder="Наименование" class="border rounded flex-1 px-2 py-1 text-sm" />
                </div>
                <div class="flex items-center gap-3 mb-3">
                    <label class="block text-sm w-[120px]">Контакты</label>
                    <input type="text" placeholder="Контакты" class="border rounded flex-1 px-2 py-1 text-sm" />
                </div>
                <div class="flex items-center gap-3 mb-3">
                    <label class="block text-sm w-[120px]">Адрес</label>
                    <input type="text" placeholder="Адрес" class="border rounded flex-1 px-2 py-1 text-sm" />
                </div>
                <div class="flex items-center gap-3 mb-3">
                    <label class="block text-sm w-[120px]">Комментарий</label>
