<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Справочник. Группы оборудования</h2>
    </x-slot>
    ...
    <main class="w-full px-2 sm:px-4 py-6">
        ...
        <!-- Заголовок -->
        <h3 class="text-lg font-semibold mb-2">Группы оборудования</h3>

        <!-- Кнопка добавления -->
        <button onclick="document.getElementById('create-group-modal').classList.remove('hidden')"
            class="bg-red-600 hover:bg-red-700 text-white font-semibold px-4 py-2 rounded text-sm mb-4">
            + Новый элемент
        </button>
        ...
        <div class="overflow-auto rounded border bg-white">
            <table class="w-full text-sm border-collapse">
                <thead class="bg-blue-50 text-xs uppercase">
                    <tr>
                        <th class="p-2 border border-gray-200">№ п.п.</th>
                        <th class="p-2 border border-gray-200">Название категории</th>
                ...
                <tbody>
                    <tr>
                        <td class="p-2 text-center border border-gray-200">1</td>
                        <td class="p-2 border border-gray-200">HILTI</td>
                        ...
                        <td class="p-2 text-center border border-gray-200">
                            ...
                            <i class="bi bi-x-lg cursor-pointer text-red-600 ml-2"></i>
                        </td>
                    </tr>
                    <tr>
                        <td class="p-2 text-center border border-gray-200">2</td>
                        <td class="p-2 border border-gray-200">IMPULSE</td>
                        <td class="p-2 border border-gray-200"></td>
                        <td class="p-2 text-center border border-gray-200">
                            <i class="bi bi-pencil cursor-pointer text-blue-600"></i>
                            <i class="bi bi-x-lg cursor-pointer text-red-600 ml-2"></i>
                    ...
                    <tr>
                        <td class="p-2 text-center border border-gray-200">3</td>
                        <td class="p-2 border border-gray-200">Quattro Elementi</td>
                        <td class="p-2 border border-gray-200"></td>
                        <td class="p-2 text-center border border-gray-200">
                            <i class="bi bi-pencil cursor-pointer text-blue-600"></i>
                            <i class="bi bi-x-lg cursor-pointer text-red-600 ml-2"></i>
    ...
    <!-- Модалка создания новой категории -->
    <div id="create-group-modal" class="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center hidden z-50">
        <div class="bg-white rounded-xl shadow-xl border border-gray-300 relative" style="width: 720px; max-width: 100%;">
            ...
            <form class="p-4">
                <div class="flex items-center gap-3 mb-3">
                    <label class="block text-sm w-[130px]">Наименование:</label>
                    <input type="text" placeholder="Наименование категории" class="border rounded flex-1 px-2 py-1 text-sm" />
                </div>
                <div class="flex items-center gap-3 mb-3">
                    <label class="block text-sm w-[130px]">Описание:</label>
                    <input type="text" placeholder="Описание группы" class="border rounded flex-1 px-2 py-1 text-sm" />
                </div>
                <div class="flex justify-end gap-2 pt-3">
                    <button type="submit" class="bg-[#337AB7] text-white px-4 py-2 rounded text-sm font-semibold"><i class="bi bi-save"></i> СОХРАНИТЬ ГРУППУ</button>
                    <button type="button" onclick="document.getElementById('create-group-modal').classList.add('hidden')" class="bg-red-500 text-white px-4 py-2 rounded text-sm font-semibold">ОТМЕНА</button>
                </div>
            </form>
        </div>
    </div>
