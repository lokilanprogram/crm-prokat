<x-app-layout>
    ...
    <main class="w-full px-2 sm:px-4 py-6">
        ...
        <h3 class="text-[18px] font-semibold mb-3 flex items-center gap-2 text-gray-800">
            <i class="bi bi-geo-alt text-red-600 text-lg"></i>
            Справочник "Категории товаров"
        </h3>

        <!-- Кнопка -->
        <div class="mb-4">
            <button onclick="openNewGroupModal()" class="bg-red-500 hover:bg-red-600 text-white font-semibold px-5 py-2 rounded text-sm shadow-md">
                + НОВЫЙ ЭЛЕМЕНТ
            </button>
        </div>
        ...
        <!-- Модалка -->
        <div id="newGroupModal" class="fixed inset-0 z-50 bg-black bg-opacity-30 flex items-center justify-center hidden">
            <div class="bg-white rounded-xl shadow-xl border border-gray-300 relative"
                style="width: 860px; max-width: 100%;">
                <!-- Header -->
                <div class="bg-[#337AB7] text-white px-4 py-2 rounded-t-xl flex justify-between items-center">
                    <span class="font-semibold">Новая группа</span>
                    <button onclick="closeNewGroupModal()" class="text-white text-2xl font-bold leading-none">&times;</button>
                </div>

                <!-- Body -->
                <div class="p-4 space-y-3 text-sm">
                    <div>
                        <label class="block mb-1">Наименование:</label>
                    ...
                    <div>
                        <label class="flex items-center gap-2 cursor-pointer select-none">
                            <span class="block mb-1">Видимость</span>
                            <span class="relative">
                        ...
                        <!-- <label class="block mb-1">Видимость:</label>
                        <input type="checkbox" class="form-checkbox"> -->
                    </div>
                </div>
                ...
                <div class="flex justify-end px-4 pb-4">
                    <button class="bg-[#337AB7] hover:bg-[#23527c] text-white px-4 py-1 text-sm font-semibold rounded">
                        <i class="bi bi-save"></i> СОХРАНИТЬ ГРУППУ
                    </button>
                </div>
            </div>
        </div>
