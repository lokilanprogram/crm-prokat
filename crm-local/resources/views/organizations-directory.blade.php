    ...
    <main class="w-full px-2 sm:px-4 py-6 min-h-screen">
        ...
        <div class="bg-white rounded-lg shadow border border-gray-200 p-4">
            <table class="w-full text-[13px] table-fixed border">
                <thead class="bg-blue-50 text-[13px] uppercase">
                    <tr>
                        <th class="p-2 border text-center w-[110px]">ИНН</th>
                        <th class="p-2 border text-center w-[68px]">Тип</th>
                        <th class="p-2 border text-center w-[140px]">Наименование</th>
                        <th class="p-2 border text-center w-[140px]">Директор</th>
                        <th class="p-2 border text-center w-[200px]">Адрес</th>
                        <th class="p-2 border text-center w-[70px]">НДС</th>
                        <th class="p-2 border text-center w-[54px]">Цвет</th>
                        <th class="p-2 border text-center w-[250px]">Действия</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="p-2 border text-center">695006121653</td>
                        <td class="p-2 border text-center">без НДС</td>
                        <td class="p-2 border text-left">ИП «Бабинский Д.С.»</td>
                        <td class="p-2 border text-left">Бабинский Дмитрий Сергеевич</td>
                        <td class="p-2 border text-left"></td>
                        <td class="p-2 border text-center"></td>
                        <td class="p-2 border text-center">
                            <input type="text" value="#FFFFFF" class="w-full border rounded px-1 text-center text-[12px]">
                        </td>
                        <td class="p-2 border text-center">
                    ...
                    <tr>
                        <td class="p-2 border text-center">6952036160</td>
                        <td class="p-2 border text-center">без НДС</td>
                        <td class="p-2 border text-left">ООО «Стройсервис»</td>
                        <td class="p-2 border text-left">Хохлов Дмитрий Александрович</td>
                        <td class="p-2 border text-left">170039, г. Тверь, ул. Хромова, 25 корп.2, помещение №7</td>
                        <td class="p-2 border text-center"></td>
                        <td class="p-2 border text-center">
                            <input type="text" value="#FFFFFF" class="w-full border rounded px-1 text-center text-[12px]">
                        </td>
        ...
        <div id="contract-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-30">
            <div class="bg-white rounded-xl shadow-xl border border-gray-300 relative"
                style="width: 860px; max-width: 100%;">
                
                <!-- Внутренние отступы -->
                <div class="p-6 pb-6 pt-4">
                    <!-- Заголовок -->
                    <div class="bg-[#337AB7] text-white text-sm font-semibold px-4 py-2 mb-4 rounded-t flex items-center justify-between">
                        <span>Настройка договора</span>
                        <button onclick="closeContractModal()" class="text-white text-xl font-bold leading-none">&times;</button>
                    </div>
                    ...
                    <div class="mb-3 flex flex-col gap-2">
                        <button class="bg-green-500 hover:bg-green-600 text-white py-2 rounded font-semibold text-sm">+ Раздел</button>
                        <button class="bg-[#337AB7] hover:bg-[#23527c] text-white py-2 rounded font-semibold text-sm">+ Пункт</button>
                    </div>

                    <!-- Поле "Предмет договора" -->
                    <input type="text" value="Предмет договора"
                        class="w-full border px-3 py-2 text-sm rounded mb-4">

                    <!-- Список пунктов -->
                    <div class="space-y-2 max-h-[360px] overflow-y-auto pr-1">
                        @for ($i = 1; $i <= 5; $i++)
                            <div class="flex gap-2 items-start">
                                <div class="w-[40px] pt-2 text-right text-sm">1.{{ $i }}</div>
                                <textarea rows="3"
                                        class="flex-1 border px-2 py-1 text-sm rounded resize-none">Арендодатель предоставляет...</textarea>
                                <button class="text-xl text-gray-600 hover:text-red-600 mt-1">&times;</button>
                            </div>
                        @endfor
                    </div>
