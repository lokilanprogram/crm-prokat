<x-app-layout>
    ...
    <main class="w-full px-2 sm:px-4 py-6 bg-[#ececec] min-h-screen">
        ...
        <!-- Блок "Акт сверки расчетов" -->
        <div class="bg-white border rounded shadow px-4 py-4 mb-5">
            <div class="font-bold text-lg mb-3">Акт сверки расчетов</div>
            <div class="flex gap-3 mb-2 items-center">
                <label class="text-[15px] min-w-[70px]">Юр. лицо:</label>
                <select class="border rounded px-2 py-1 text-sm min-w-[270px]">
                    <option>ООО "ИНСТРУМЕНТ МИЛИОС"</option>
                    <option>ООО "Стройсервис"</option>
                    <option>ИП "Бабинский Д.С."</option>
                </select>
                <input type="text" placeholder="Поиск..." class="border rounded px-2 py-1 text-sm min-w-[170px] ml-2">
                <button class="bg-[#337AB7] hover:bg-[#23527c] text-white font-semibold px-3 py-2 rounded text-sm flex items-center gap-2 ml-2">
                    <i class="bi bi-calculator"></i> РАССЧИТАТЬ АКТ
                </button>
            </div>
            <div class="text-base font-semibold mb-2">
                Баланс: <span class="text-gray-800">ООО «Стройсервис»</span>: <span class="font-bold">0.00</span>
            </div>
                ...
                <table class="w-full text-sm text-left border border-gray-200">
                    <thead class="bg-blue-50 text-xs uppercase">
                        <tr>
                            ...
                            <th class="p-2 border">Платёж</th>
                            <th class="p-2 border">Реализация</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="p-2 border">16.06.2025</td>
                            <td class="p-2 border">ООО «Стройсервис»</td>
                            <td class="p-2 border">[прокат 24579] [Расписка №24579]</td>
                            <td class="p-2 border">6 300.00</td>
                            <td class="p-2 border">6 300.00</td>
                            <td class="p-2 border">Хохлов Дмитрий</td>
                        ...
                        <tr>
                            ...
                            <td class="p-2 border">11.06.2025</td>
                            <td class="p-2 border">ООО «Стройсервис»</td>
                            <td class="p-2 border">пополнение баланса [Расписка №441]</td>
                            <td class="p-2 border">6 300.00</td>
                        ...
                        <tr>
                            ...
                            <td class="p-2 border">28.04.2025</td>
                            <td class="p-2 border">ООО «Стройсервис»</td>
                            <td class="p-2 border">[прокат 24579] [Расписка №24579]</td>
                            <td class="p-2 border">12 600.00</td>
                            <td class="p-2 border">12 600.00</td>
                            <td class="p-2 border">Хохлов Дмитрий</td>
                            <td class="p-2 border text-center">
                                <i class="bi bi-pencil-square text-lg text-blue-600 cursor-pointer"></i>
                        ...
                        <tr>
                            ...
                            <td class="p-2 border">26.03.2025</td>
                            <td class="p-2 border">ООО «Стройсервис»</td>
                            <td class="p-2 border">[прокат 24579] [Расписка №24579]</td>
                            <td class="p-2 border">12 600.00</td>
                            <td class="p-2 border">12 600.00</td>
                        ...
                        <tr class="font-semibold">
                            <td class="p-2 border text-right" colspan="4">Итого:</td>
                            <td class="p-2 border">31 500.00</td>
                            <td class="p-2 border">31 500.00</td>
                            <td class="p-2 border"></td>
                            <td class="p-2 border text-center text-black">0.00</td>
                        </tr>
                    </tbody>
                </table>
            </div>
