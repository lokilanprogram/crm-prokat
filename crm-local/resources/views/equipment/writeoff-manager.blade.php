<x-app-layout>
            ...
            <table class="w-full text-sm text-left border border-gray-200">
                ...
                <tbody>
                    <tr class="border-b">
                        ...
                        <td class="p-2 text-center">43 052.00</td>
                        <td class="p-2 text-center text-green-600 font-bold">33 052.00</td>
                        <td class="p-2 text-center">
                            <img src="https://randomuser.me/api/portraits/men/12.jpg" alt="user" class="w-9 h-9 rounded-full border border-gray-200 mx-auto">
                        </td>
                        <td class="p-2 text-center">п</td>
                        <td class="p-2 text-center">
                            <i class="bi bi-recycle text-xl text-green-600"></i>
                        </td>
                    </tr>
                    <tr class="border-b">
                        ...
                        <td class="p-2 text-center">0.00</td>
                        <td class="p-2 text-center">2</td>
                        <td class="p-2 text-center">650.00</td>
                        <td class="p-2 text-center text-red-600 font-bold">-9 350.00</td>
                        <td class="p-2 text-center">
                            <img src="https://randomuser.me/api/portraits/men/13.jpg" alt="user" class="w-9 h-9 rounded-full border border-gray-200 mx-auto">
                        </td>
                        <td class="p-2 text-center">п</td>
                        <td class="p-2 text-center">
                            <i class="bi bi-recycle text-xl text-green-600"></i>
                    ...
                    <tr class="border-b">
                        ...
                        <td class="p-2 text-center">29 915.00</td>
                        <td class="p-2 text-center text-green-600 font-bold">19 915.00</td>
                        <td class="p-2 text-center">
                            <img src="https://randomuser.me/api/portraits/men/14.jpg" alt="user" class="w-9 h-9 rounded-full border border-gray-200 mx-auto">
                        </td>
                        <td class="p-2 text-center">п</td>
                        <td class="p-2 text-center">
                            <i class="bi bi-recycle text-xl text-green-600"></i>
                    ...
                    <tr>
                        ...
                        <td class="p-2 text-center">0.00</td>
                        <td class="p-2 text-center text-red-600 font-bold">-10 000.00</td>
                        <td class="p-2 text-center">
                            <img src="https://randomuser.me/api/portraits/men/15.jpg" alt="user" class="w-9 h-9 rounded-full border border-gray-200 mx-auto">
                        </td>
                        <td class="p-2 text-center">п</td>
                        <td class="p-2 text-center">
                            <i class="bi bi-recycle text-xl text-green-600"></i>
    ...
    >
        <div class="bg-white rounded-xl shadow-2xl w-full max-w-[670px] flex flex-col overflow-visible my-6">
            <!-- Заголовок -->
            <div class="flex justify-between items-center bg-sky-700 text-white px-4 py-2 rounded-t-xl">
    ...
    <template x-teleport="body">
        ...
        >
            <div class="bg-white rounded-xl shadow-2xl w-full max-w-[650px] flex flex-col overflow-visible my-6 border border-gray-200 relative">
                <!-- Заголовок -->
                <div class="flex justify-between items-center bg-blue-700 text-white px-4 py-2 rounded-t-xl">
        ...
        >
            <div class="bg-white rounded-xl shadow-2xl w-full max-w-[800px] flex flex-col overflow-visible my-2 border border-gray-200 relative" style="max-height: 95vh;">
                ...
                <div class="flex flex-col w-full">
                    <div class="flex justify-between items-center bg-[#0291db] text-white px-3 py-1 rounded-t-xl relative">
