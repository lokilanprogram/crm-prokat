<!-- resources/views/branches-directory.blade.php -->

<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            общий справочник филиалы
        </h2>
    </x-slot>

    <main class="w-full mx-auto px-4 py-6 bg-[#ececec] min-h-screen">
        ...
        <div class="mt-6">
            <div class="flex items-center gap-4 mb-4">
                <span class="text-lg font-semibold">Справочник "Филиалы"</span>
                <button onclick="openBranchModal()"
                    class="bg-red-500 hover:bg-red-600 text-white font-semibold px-4 py-2 rounded text-base flex items-center gap-2">
                    + НОВЫЙ ФИЛИАЛ
                </button>
            </div>
            <div class="bg-white rounded-lg shadow border border-gray-200 p-4 w-full">
    <table class="w-full text-[12px] border border-gray-300 table-fixed">
        <thead class="bg-blue-50 text-[9px] uppercase">
            <tr>
                <th class="p-1 px-2 border text-center w-8">№ п.п.</th>
                <th class="p-1 px-2 border text-center w-12">Активн.</th>
                <th class="p-1 px-2 border text-center w-20">Кратко</th>
                <th class="p-1 px-2 border text-center w-28">Наим.</th>
                <th class="p-1 px-2 border text-center w-16">Город</th>
                <th class="p-1 px-2 border text-center w-36">Адрес</th>
                <th class="p-1 px-2 border text-center w-28">Телефон</th>
                <th class="p-1 px-2 border text-center w-20">Мессенджеры</th>
                <th class="p-1 px-2 border text-center w-32">E-mail</th>
                <th class="p-1 px-2 border text-center w-16">Распис.</th>
                <th class="p-1 px-2 border text-center w-28">Руководитель</th>
                <th class="p-1 px-2 border text-center w-10">Осн.</th>
                <th class="p-1 px-2 border text-center w-28">Организация</th>
                <th class="p-1 px-2 border text-center w-20">Логотип</th>
            </tr>
        </thead>
        <tbody>
            <tr class="align-middle">
                <td class="p-1 px-2 border border-gray-300 text-center align-middle">1</td>
                <td class="p-1 px-2 border border-gray-300 text-center align-middle">✔</td>
                <td class="p-1 px-2 border border-gray-300 text-center align-middle">Светлая 42</td>
                <td class="p-1 px-2 border border-gray-300 text-center align-middle">
                    <a href="#" class="text-blue-700 underline">Светлая 42</a>
                </td>
                <td class="p-1 px-2 border border-gray-300 text-center align-middle">г. Тверь</td>
                <td class="p-1 px-2 border border-gray-300 text-center align-middle">Тверь, ул.Светлая 42</td>
                <td class="p-1 px-2 border border-gray-300 text-center align-middle">+7(4822) 64-33-22,<br>8-920-164-4279</td>
                <td class="p-1 px-2 border border-gray-300 text-center align-middle"></td>
                <td class="p-1 px-2 border border-gray-300 text-center align-middle">stroyservice-tver@yandex.ru</td>
                <td class="p-1 px-2 border border-gray-300 text-center align-middle"></td>
                <td class="p-1 px-2 border border-gray-300 text-center align-middle">Дмитрий Хохлов</td>
                <td class="p-1 px-2 border border-gray-300 text-center align-middle">✔</td>
                <td class="p-1 px-2 border border-gray-300 text-center align-middle">ООО «Стройсервис»</td>
                <td class="p-1 px-2 border border-gray-300 text-center align-middle">
                    <img src="/img/logo_stroy.png" class="w-16 h-16 object-contain mx-auto" alt="">
                </td>
            </tr>
            <tr class="align-middle">
                <td class="p-1 px-2 border border-gray-300 text-center align-middle">2</td>
                <td class="p-1 px-2 border border-gray-300 text-center align-middle">✔</td>
                <td class="p-1 px-2 border border-gray-300 text-center align-middle">Берибайк</td>
                <td class="p-1 px-2 border border-gray-300 text-center align-middle">
                    <a href="#" class="text-blue-700 underline">Берибайк</a>
                </td>
                <td class="p-1 px-2 border border-gray-300 text-center align-middle">г. Тверь</td>
                <td class="p-1 px-2 border border-gray-300 text-center align-middle">Тверь, ул. Светлая 42</td>
                <td class="p-1 px-2 border border-gray-300 text-center align-middle">606040</td>
                <td class="p-1 px-2 border border-gray-300 text-center align-middle">Viber, WhatsApp</td>
                <td class="p-1 px-2 border border-gray-300 text-center align-middle">beribike@yandex.ru</td>
                <td class="p-1 px-2 border border-gray-300 text-center align-middle"></td>
                <td class="p-1 px-2 border border-gray-300 text-center align-middle">Бабинский Дмитрий Сергеевич</td>
                <td class="p-1 px-2 border border-gray-300 text-center align-middle"></td>
                <td class="p-1 px-2 border border-gray-300 text-center align-middle">ИП «Бабинский Д.С.»</td>
                <td class="p-1 px-2 border border-gray-300 text-center align-middle">
                    <img src="/img/logo_beribike.png" class="w-16 h-16 object-contain mx-auto" alt="">
                </td>
            </tr>
        </tbody>
    </table>
        ...
        <div id="branch-modal" class="fixed z-50 inset-0 bg-black bg-opacity-30 flex items-center justify-center hidden">
            <div class="bg-white rounded-xl shadow-2xl border border-gray-300 relative"
                style="width: 500px; max-width: 98vw; max-height: 96vh; overflow-y: auto;">
                
                <!-- Заголовок -->
                <div class="flex justify-between items-center px-4 py-2 rounded-t-xl"
                    style="background-color:#0076C6; color: white;">
                    <span class="font-semibold text-sm">Создание нового филиала</span>
                    <button onclick="closeBranchModal()" class="text-white text-2xl font-bold leading-none">&times;</button>
                </div>

                <form class="px-4 pt-3 pb-3 text-sm">
                    <!-- Переключатели -->
                    <div class="flex gap-4 mb-2">
                        ...
                        <label class="flex items-center gap-2">
                            <span>Филиал проката:</span>
                            <input type="checkbox" class="accent-green-600 w-4 h-4">
                        </label>
                    </div>

                    <!-- Поля в строчку: Метка слева, инпут справа -->
                    @php
                        $fields = [
                            ['Город', 'введите город'],
                            ['Кратко', 'введите краткое наименование'],
                            ['Наименование', 'введите полное наименование'],
                            ['Адрес', 'введите адрес'],
                            ['Телефоны', 'введите контактные номера телефонов'],
                            ['Мессенджеры', 'введите мессенджеры'],
                            ['E-mail', 'введите e-mail'],
                            ['Расписание', 'введите расписание'],
                            ['Руководитель', 'введите ФИО руководителя'],
                            ['IP офиса', 'введите IP офиса'],
                        ];
                    @endphp

                    @foreach($fields as [$label, $placeholder])
                        <div class="flex items-center mb-2">
                            <label class="w-[140px] text-sm">{{ $label }}:</label>
                            <input type="text" placeholder="{{ $placeholder }}" class="flex-1 border rounded px-2 py-1 h-[26px] text-sm">
                        </div>
                    @endforeach

                    <!-- Организация -->
                    <div class="flex items-center mb-2">
                        <label class="w-[140px] text-sm">Организация:</label>
                        <select class="flex-1 border rounded px-2 py-1 h-[26px] text-sm">
                    ...
                    <div class="flex items-center mb-3">
                        <label class="w-[140px] text-sm">Логотип:</label>
                        <div class="flex-1">
                            <input type="file" class="border rounded px-2 py-1 h-[26px] text-sm w-full">
                            <span class="text-gray-500 text-xs">Файл не выбран</span>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-end gap-2 pt-1">
                        <button type="submit"
                                class="bg-blue-600 text-white px-5 py-1.5 rounded text-sm font-semibold">СОХРАНИТЬ ЭЛЕМЕНТ</button>
                        <button type="button" onclick="closeBranchModal()"
                                class="bg-gray-400 text-white px-5 py-1.5 rounded text-sm font-semibold">ОТМЕНА</button>
                    </div>
                </form>
            </div>
        </div>
