...
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            администрирование доступ сотрудников
        </h2>
    </x-slot>
    ...
    <main class="w-full px-2 sm:px-4 py-6">
        ...
        <!-- Назначение доступа -->
        <div class="flex gap-14 items-start mt-8">
            <!-- Таблица меню и чекбоксы доступа -->
            <div class="flex-1 min-w-[380px] mr-12">
                <h3 class="font-semibold text-[19px] mb-2">Назначение доступа пользователям</h3>
                <div class="text-xs text-gray-500 mb-2">Создание меню приложения</div>
                <table class="w-full border border-gray-300 text-[15px] bg-white rounded shadow">
                    <thead>
                        <tr class="bg-gray-100">
                            <th class="p-2 border border-gray-300">Название пункта</th>
                            <th class="p-2 border border-gray-300">Ссылка</th>
                            <th class="p-2 border border-gray-300 w-9"></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr class="border-b border-gray-300">
                            <td class="p-2 pl-6 text-xs border border-gray-300"> - Расписание (88)</td>
                            <td class="p-2 text-xs border border-gray-300">/admin/users/worktime</td>
                            <td class="p-2 text-center border border-gray-300"><input type="checkbox"></td>
                        </tr>
                        <tr class="border-b border-gray-300">
                            <td class="p-2 pl-6 text-xs border border-gray-300">
                                <a href="/admin/users/index"
                            ...
                            <td class="p-2 text-xs border border-gray-300">/admin/users/index</td>
                            <td class="p-2 text-center border border-gray-300"><input type="checkbox"></td>
                        </tr>
                        <tr class="border-b border-gray-300">
                            <td class="p-2 pl-6 text-xs border border-gray-300"> - Константы (98)</td>
                            <td class="p-2 text-xs border border-gray-300">/admin/tunes/</td>
                            <td class="p-2 text-center border border-gray-300"><input type="checkbox"></td>
                        </tr>
                        <tr class="border-b border-gray-300">
                            <td class="p-2 pl-6 text-xs border border-gray-300"> - Пункты меню (92)</td>
                            <td class="p-2 text-xs border border-gray-300">/admin/menus/index</td>
                            <td class="p-2 text-center border border-gray-300"><input type="checkbox"></td>
                        </tr>
                        <tr class="border-b border-gray-300">
                            <td class="p-2 pl-6 text-xs border border-gray-300"> - Очистить кэш (124)</td>
                            <td class="p-2 text-xs border border-gray-300">/handbooks/clear_cache</td>
                            <td class="p-2 text-center border border-gray-300"><input type="checkbox"></td>
                        </tr>
                        <tr>
            ...
            <div class="flex flex-col items-start gap-3 min-w-[290px]">
